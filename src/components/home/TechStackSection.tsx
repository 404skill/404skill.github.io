  ...
  return (
    <section className="bg-muted/50 py-16 md:py-20">
      <div className="container">
        <h2 className="mb-4 text-center text-2xl font-bold font-mono">
        ...
        <div className="flex flex-wrap justify-center gap-6 mb-16">
          ...
          <TechIcon
            name="Any Framework"
            icon={<Layers className="h-5 w-5 mr-2 text-purple-500" />}
          />
        ...
        <div className="mt-8 text-center text-sm text-muted-foreground max-w-2xl mx-auto mb-12">
          <p>
            Focus on solving problems your way while our standardized testing interface verifies
