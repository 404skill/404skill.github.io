...
import { BookOpen, CheckCircle, Code, Download, HelpCircle, ScrollText, ArrowRight, Zap, Rocket, Target, Users, Trophy, Sparkles } from "lucide-react";
  ...
  return (
    <section className="relative py-32 overflow-hidden">
      ...
      <div className="container relative">
        ...
        <div className={`text-center mb-20 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: "150ms" }}>
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/80" style={{ minHeight: "1.5em"}}>
            How You'll Level Up
          </h2>
          <p className="text-lg text-muted-foreground max-w-[42rem] mx-auto leading-relaxed">
            A structured approach to becoming a better backend engineer, with expert guidance every step of the way.
          </p>
        </div>
        ...
        <div className="mb-20">
          ...
          <p className="text-md text-muted-foreground text-center mb-10">Follow these three steps to accelerate your backend engineering journey.</p>
        ...
        <div className="mt-24 text-center relative">
          ...
          <blockquote className="mt-8 text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            "I was always thinking about how to make my resume more impressive and my skills more attractive. You can't always get that experience while on the job, so I spent time building different projects using tech I wanted to learn. That's how I gained much more experience and became an attractive hire. Now I'm working at Microsoft."
          </blockquote>
        ...
        <div className={`text-center mt-24 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: "550ms" }}>
          <Link to="/auth">
            <Button size="lg" className="gap-3 group hover-button font-mono gradient-primary text-primary-foreground px-8 py-6 text-lg shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 transition-all duration-300">
