...
export const projects: Project[] = [
  {
    ...
    description:
      "Build a backend system that manages a library's collection and handles user memberships, borrowing, and a promotion system.",
    difficulty: 'medium',
    tasks: [
      {
        id: 't1',
        name: 'Storing Users',
        description:
          'Create a data model and endpoints for storing user information with different membership levels.',
      },
      {
        id: 't2',
        name: 'Creating Items',
        description:
          'Define and manage library items (books, magazines, DVDs) with proper data models and endpoints.',
      },
      {
        id: 't3',
        name: 'Borrowing & Returning',
        description:
          'Implement the core library functionality for borrowing and returning items with membership limits.',
      },
      {
        id: 't4',
        name: 'Adding Music CDs',
        description:
          'Extend your catalog by introducing music CDs as a new item type with appropriate borrowing rules.',
      },
      {
        id: 't5',
        name: 'Promotion System',
        description:
          'Add a promotion feature that rewards avid readers by doubling their book borrowing limit.',
      },
    ],
    technologies: [],
