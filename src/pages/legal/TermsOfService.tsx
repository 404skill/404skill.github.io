  ...
  return (
    <div className="container max-w-4xl py-12">
      ...
      <div className="prose prose-gray dark:prose-invert">
        ...
        <p>
          By accessing and using 404Skill ("the Service"), you agree to be bound by these Terms of
        ...
        <p>
          By subscribing to our Service, you agree to pay the subscription fees as described in the
          pricing section. Subscriptions are billed in advance on a monthly or annual basis and are
        ...
        <h2>5. Disclaimer</h2>
        <p>
          The materials on the Service are provided on an 'as is' basis. 404Skill makes no
        ...
        <p>
          ...
          photographic errors. 404Skill does not warrant that any of the materials on its website
          are accurate, complete, or current. We may make changes to the materials contained on the
          Service at any time without notice.
        </p>

        <h2>8. Links</h2>
        <p>
          404Skill has not reviewed all of the sites linked to its Service and is not responsible
          for the contents of any such linked site. The inclusion of any link does not imply
          endorsement by 404Skill of the site.
        </p>

        <h2>9. Modifications</h2>
        <p>
          404Skill may revise these terms of service at any time without notice. By using the
