...
// import {ProfileTest, Project, Test, TestResult} from "@/lib/types";
...
// import {fetchProject, fetchProjectTasks, fetchProjectTestResults, fetchTaskTests} from "@/lib/api.ts";
// import {convertProject} from "@/lib/converter.ts";
//
...
//           const convertedProject = convertProject(projectData);
//
//           const tasks = await fetchProjectTasks(id);
//           convertedProject.tasks = tasks;
//
//           setProject(convertedProject);
//
//           const profileTestResults = await fetchProjectTestResults(id);
//           const convertedResults: TestResult[] = profileTestResults.map((pt) => ({
//             taskId: '', // You need to resolve this
//             projectId: id,
...
//             const taskTests = await fetchTaskTests(task.id);
//             const passedForTask = taskTests.filter(t =>
//                 profileTestResults.find(r => r.testId === t.id && r.passed)
//             ).length;
//             totalTests += taskTests.length;
//             passedTests += passedForTask;
//           }
//
//           setCompletion(totalTests > 0 ? (passedTests / totalTests) * 100 : 0);
//
//           trackEvent({
