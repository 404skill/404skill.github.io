      ...
      <div className="project-card overflow-hidden">
        <CardContent className="flex flex-col items-center justify-center py-16">
          ...
          <p className="text-muted-foreground mt-2 mb-6 text-center max-w-md font-mono">
            You haven't started any projects yet. Browse our catalog and choose a project to begin
  ...
  return (
    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
      {userProjects.map((proj, idx) => (
        <div key={proj.id} className="animate-fade-in" style={{ animationDelay: `${idx * 75}ms` }}>
          <ProjectCard
            project={proj}
